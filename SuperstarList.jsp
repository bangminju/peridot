...
<%
	...
	CategoryVO cvo = (CategoryVO)request.getAttribute("ctgn");
%>    
<!DOCTYPE html>
<html>
<head>
		...
		<div class="menu">
			...
			<div class="woman">
				...
				<div class="warea">
					...
					%>
					<img src="/img/슈퍼스타이미지.png"><a href="/List/SuperstarList?categoryCode=<%= vo.getCategoryCode() %>&categoryGen=<%=vo.getCategoryGen()%>">슈퍼스타<br></a>
					<%
...
<!-- 상품리스트 보여주눈 곳 -->    
<div class="mainn">	
	<div class="mmaa" style="display:flex;">
			<%
			for(ProductVO vo : plist){
			%>
			<a href="/List/Detail?productNo=<%=vo.getProductNo()%>">
				<img src="/resources/img/<%= vo.getProductImg1()%>" class="imgsize"><br>
				<div class="mmaaa">
